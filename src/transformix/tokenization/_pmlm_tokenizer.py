...
# Default amino acid tokenizer
VOCAB_PATH = importlib.resources.files("transformix") / "assets" / "tokenizer" / "aa_tokenizer" / "vocab.txt"

PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = 1024
...
class PmlmTokenizer(PreTrainedTokenizer):
    ...
    model_max_length = PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES
